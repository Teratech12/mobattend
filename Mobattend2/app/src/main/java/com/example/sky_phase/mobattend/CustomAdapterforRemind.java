...
public class CustomAdapterforRemind extends ArrayAdapter<DataModelForListForData> implements View.OnClickListener {
    ...
    public CustomAdapterforRemind(ArrayList<DataModelForListForData> data, Context context){
