...
public class CustomAdapterforGrid extends ArrayAdapter<DataModelForGrid> implements View.OnClickListener {
    ...
    public CustomAdapterforGrid(ArrayList<DataModelForGrid> data, Context context){
        super(context, R.layout.row_item_reminder,data);
        this.dataSet = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.row_item_reminder, parent, false);
            viewHolder.imageView = (ImageView) convertView.findViewById(R.id.item_info);
            viewHolder.txtName = (TextView) convertView.findViewById(R.id.name);
            viewHolder.txtType = (TextView) convertView.findViewById(R.id.type1);
